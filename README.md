...
*(Only listing what's backed by coursework/repos — no Tableau/Power BI/ML badges until there's a project to point to.)*

---

### Featured Project

**[Data-Handling-and-Preprocessing-EDA](https://github.com/Abhishekchaudhari21/Data-Handling-and-Preprocessing-EDA)**
Data cleaning and exploratory data analysis using Python.
*(Update this repo's README with what the project actually does, the dataset used, and 2-3 key findings — a one-line description undersells it.)*
